...
def plot_all_figures(train_losses, test_losses, 
    ...
    plt.ylabel("Last value of Loss", fontsize=14)
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$\langle x_{true}-x_{model} \rangle [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$\langle y_{true}-y_{model} \rangle [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$\langle z_{true}-z_{model} \rangle [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$std(E_{true}-E_{model}) [MeV]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$std(x_{true}-x_{model}) [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$std(y_{true}-y_{model}) [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax.set_xlabel("Number of epochs", fontsize=14)
    ax.set_ylabel(r"$std(z_{true}-z_{model}) [mm]$", fontsize=14)
    plt.grid()
    plt.legend()
    ...
    ax1.loglog(range(n_epochs+1), train_losses, color='blue', label='Training Loss')
    ax1.loglog(range(n_epochs+1), test_losses, color='red', label='Test Loss')
